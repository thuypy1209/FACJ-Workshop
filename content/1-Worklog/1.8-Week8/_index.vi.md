...
| ---- | ----------------------------------------------------------------------------------------------------------------------- | ------------ | ---------------- | ------------------------------------------ |
| 1    | - Xây dựng giao diện trang Đăng nhập / Đăng ký: form email/mật khẩu và validate dữ liệu                                 | 22/06/2026   | 22/06/2026        | -                                           |
...
| 4    | - Cấu hình Axios interceptor để tự động đính kèm JWT Token vào Authorization Header của mỗi request                    | 25/06/2026   | 25/06/2026        | -                                           |
| 5    | - **Thực hành:** kiểm thử toàn bộ luồng đăng nhập, xử lý lỗi đăng nhập và trường hợp token hết hạn                      | 26/06/2026   | 26/06/2026        | -                                           |

### Thành quả tuần 8:

* Hoàn thành chức năng đăng nhập/đăng ký trên Frontend, kết nối đầu-cuối với Cognito, khớp với bước 4 trong sơ đồ kiến trúc.
* Lưu trữ và quản lý JWT Token thành công sau khi đăng nhập.
* Cấu hình Axios interceptor để tự động đính kèm token vào mọi request API, hỗ trợ bước xác nhận danh tính (bước 7) khi gửi yêu cầu đặt tour.
* Xử lý các trường hợp lỗi cơ bản (sai mật khẩu, token hết hạn), chuẩn bị xây dựng tính năng hiển thị dữ liệu tour ở tuần 9.
