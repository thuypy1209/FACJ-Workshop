...
| 2   | - Connect the login/register form to the Cognito authentication API via API Gateway                                  | 06/23/2026 | 06/23/2026      | -                                           |
| 3   | - Store the JWT Token (Access Token, Refresh Token) after a successful login                                          | 06/24/2026 | 06/24/2026      | -                                           |
| 4   | - Configure the Axios interceptor to automatically attach the JWT Token to the Authorization Header of every request | 06/25/2026 | 06/25/2026      | -                                           |
| 5   | - **Practice:** test the full login flow, handle login errors and expired token cases                                | 06/26/2026 | 06/26/2026      | -                                           |

### Week 8 Achievements:

* Completed the login/register feature on the Frontend, connected end-to-end with Cognito, matching step 4 of the architecture diagram.
* Successfully stored and managed the JWT Token after login.
* Configured the Axios interceptor to automatically attach the token to every API request, supporting the identity-verification step (step 7) when a booking request is submitted.
* Handled basic error cases (wrong password, expired token), preparing to build tour-booking data-display features in Week 9.
