...
| --- | -------------------------------------------------------------------------------------------------------------------------------- | ---------- | --------------- | ------------------------------------------ |
| 1   | - Study REST API concepts in API Gateway: resource, method, integration, stage                                                   | 06/08/2026 | 06/08/2026      | <https://cloudjourney.awsstudygroup.com/>  |
| 2   | - Create the API Gateway and define endpoints for Tours and Bookings (GET, POST, PUT, DELETE)                                    | 06/09/2026 | 06/09/2026      | -                                           |
| 3   | - Integrate each endpoint with the corresponding Lambda function created in Week 5                                               | 06/10/2026 | 06/10/2026      | -                                           |
| 4   | - Configure a WAF Web ACL in front of API Gateway to filter malicious traffic (step 5), and configure CORS for the endpoints     | 06/11/2026 | 06/11/2026      | -                                           |
| 5   | - Set up a Cognito Authorizer to secure the endpoints <br> - **Practice:** test the endpoints with Postman using a valid/invalid token | 06/12/2026 | 06/12/2026      | -                                           |
