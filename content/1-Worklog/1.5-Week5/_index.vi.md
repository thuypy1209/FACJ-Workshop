...
| ---- | -------------------------------------------------------------------------------------------------------------------------- | ------------ | ---------------- | ------------------------------------------ |
| 1    | - Thiết lập cấu trúc dự án Lambda Node.js, cài đặt AWS SDK và cấu hình biến môi trường                                     | 01/06/2026   | 01/06/2026        | <https://docs.aws.amazon.com/lambda/>  |
...
| 4    | - Triển khai logic xác minh JWT Token trong các hàm Lambda trước khi xử lý request <br> - Triển khai upload ảnh/tài liệu đặt tour lên S3 Storage | 04/06/2026   | 04/06/2026        | <https://docs.aws.amazon.com/lambda/>                                          |
...
* Hoàn thành các hàm Lambda (Node.js) xử lý logic CRUD cho Tours và Bookings.
* Triển khai thành công việc xác minh JWT Token tại tầng Backend, đảm bảo chỉ request đã xác thực mới được xử lý.
* Triển khai lưu ảnh/tài liệu đặt tour vào S3 Storage và dữ liệu tour vào DynamoDB.
