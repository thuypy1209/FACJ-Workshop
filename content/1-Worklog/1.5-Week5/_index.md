...
| --- | ---------------------------------------------------------------------------------------------------------------------------- | ---------- | --------------- | ------------------------------------------ |
| 1   | - Set up the Node.js Lambda project structure, install the AWS SDK, and configure environment variables                      | 06/01/2026 | 06/01/2026      | <https://cloudjourney.awsstudygroup.com/>  |
...
| 4   | - Implement JWT Token verification logic in the Lambda functions before processing requests <br> - Implement uploading booking images/documents to S3 Storage | 06/04/2026 | 06/04/2026      | -                                           |
