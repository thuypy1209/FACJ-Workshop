...
* Hoàn thiện tổng thể giao diện (UI/UX) của ứng dụng.
* Dàn trang các trang bằng Flexbox và xử lý Responsive theo từng kích thước màn hình.
* Xây dựng các khối thông tin khuyến mãi trên trang chủ, và triển khai bản build Frontend mới nhất lên S3 Frontend phía sau CloudFront (bước 2-3 trong sơ đồ kiến trúc).

### Công việc thực hiện trong tuần:
| Ngày | Công việc                                                                                                          | Ngày bắt đầu | Ngày hoàn thành | Tài liệu tham khảo                        |
| ---- | -------------------------------------------------------------------------------------------------------------- | ------------ | ---------------- | ------------------------------------------ |
| 1    | - Rà soát tổng thể giao diện và liệt kê các màn hình/component cần hoàn thiện thêm về thẩm mỹ                    | 06/07/2026   | 06/07/2026        | -                                           |
